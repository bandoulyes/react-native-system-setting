...
export default class SystemSetting {
    ...
    static grantWriteSettingPremission() {
        __DEV__ && console.warn('grantWriteSettingPremission has been renamed to grantWriteSettingPermission, see https://github.com/bandoulyes/react-native-system-setting/pull/98')
